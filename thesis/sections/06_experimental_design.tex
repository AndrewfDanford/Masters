...
At the time of this draft, the executable pipeline is complete for E0, E1, E2--E3, E7, and E8 in an artifact-driven form. Concretely, the repository includes:
\begin{itemize}
...
\end{itemize}
E4--E6 model training is not yet implemented in this draft, but artifact schemas and method contracts are frozen to prevent interface drift during implementation. E9 remains pending as a dedicated stress-test data-builder and evaluation track.
