...
diagnosis be compared when explanation families (saliency, concepts, text) use different
assumptions, outputs, and evaluation conventions? Existing studies frequently evaluate one family at
a time, on different datasets and metrics, making cross-family conclusions difficult.
...
examine whether constrained, concept-grounded text rationales are more faithful than
less-constrained textual explanations.

\section{Contributions}
\begin{enumerate}
  \item A reproducible experimental protocol that compares saliency-, concept-, and text-based
  explanations on the same chest X-ray prediction setting.
  ...
  \item A dedicated analysis of constrained versus less-constrained textual rationales, motivated
  by recent radiology report-generation progress and known factuality limitations
