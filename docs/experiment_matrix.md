...
- Text comparison: deferred to future work.
...
| E7 | Unified perturbation benchmark across E2-E4 | Standardized perturbation suite | Method-wise faithfulness curves | Cross-family faithfulness score + paired CI tests | Main thesis claim |
| E8 | Randomization sanity checks for E2-E4 | Controlled randomization runs | Sensitivity signatures | Correlation drop / sanity-test pass rates | Validate non-spurious explanation behavior |
...
|---|---|---|---|
| A1 | Concept supervision fraction (25/50/100%) | E4 | Tests dependence on concept label density |
| A2 | Evidence granularity (coarse vs fine perturbation masks) | E2-E4 | Tests robustness of faithfulness conclusions |
...
- Predefine primary endpoints: component faithfulness metrics (sanity, perturbation, robustness) from E7.
- Report NFI as a secondary aggregate summary, not as standalone evidence.
...
1. Core experiments E1-E8 executed with reproducible configs (E9 optional extension).
